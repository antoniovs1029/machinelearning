...
namespace Samples.Dynamic.Trainers.Regression
{
    class PermutationFeatureImportance2
    {
        public static void Example()
        {
            ...
            //TransformerChain<RegressionPredictionTransformer<OlsModelParameters>> loadedModel = 
            //    (TransformerChain<RegressionPredictionTransformer<OlsModelParameters>>)mlContext.Model.Load(modelPath, out var schema);
            ...
            var LastTransformer = (loadedModel as TransformerChain<ITransformer>).LastTransformer as RegressionPredictionTransformer<IPredictorProducing<float>>;

            // var LastTransformer = (loadedModel as TransformerChain<ITransformer>).LastTransformer as RegressionPredictionTransformer<ISingleFeaturePredictionTransformer<OlsModelParameters>>;

            // RegressionPredictionTransformer<OlsModelParameters> linearPredictor = LastTransformer as RegressionPredictionTransformer<OlsModelParameters>;

            var linearPredictor = LastTransformer;
