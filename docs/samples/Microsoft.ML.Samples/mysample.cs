...
namespace ConsoleApp10ML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\anvelazq\Desktop\issue04\original-problem\tiny\asdfas.tsv";
        ...
        public static IEstimator<ITransformer> BuildTrainingPipeline(MLContext mlContext)
        {
            ...
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey("Label", "Label")
                                      .Append(mlContext.Transforms.LoadImages("ImagePath_featurized", @"C:\Users\anvelazq\Desktop\issue04\original-problem\tiny", "ImagePath"))
        ...
        public static string GetAbsolutePath(string relativePath)
        {
            ...
            string fullPath = Path.Combine("C:\\Users\\anvelazq\\Desktop\\", relativePath);
    ...
    public static class ModelConsumer
    {
        //Dataset to use for predictions 
        private const string DATA_FILEPATH = @"C:\Users\anvelazq\Desktop\issue04\original-problem\tiny\asdfas.tsv";
        ...
        public static void Run()
        {
            ...
            Console.WriteLine($"ImagePath: {sampleData.ImagePath}");
